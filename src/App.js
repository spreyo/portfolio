    ...
    <>
      ...
      <div id="projects-div">
        <div id="projects-background">
          <ProjectCard image="/images/clicket.png" text={<><p className='card-text'>
            ...
            linkText="github" />
          <ProjectCard image="/images/weather.png" text={<><p className='card-text'>
          ...
          <ProjectCard image="/images/zoom.png" text={<><p className='card-text'>
          ...
          <ProjectCard image="/images/latte.png" text={<><p className='card-text'>
          ...
          <ProjectCard image="/images/balls.png" text={<><p className='card-text'>
